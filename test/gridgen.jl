...
@testset "gen_lprim1d for fixed intervals to fail" begin
    domain = OpenInterval(MaxwellFDM.Float.((-3.155830993045275,1.1707739814306768)),MaxwellFDM.Float(0.13507892645230862))
...
@testset "gen_lprim1d for randomly generated intervals" begin  # case generated by @testset "gen_lprim1d for random intervals"
    domain = OpenInterval(MaxwellFDM.Float(.(-2.4275370034248813,1.5578784568403026)),MaxwellFDM.Float(0.0038696573133163836))
